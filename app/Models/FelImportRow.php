...
{
    protected $fillable = ['fel_import_batch_id', 'source_filename', 'sheet_name', 'row_number', 'authorization_uuid', 'status', 'error_code', 'processing_stage', 'message', 'fel_document_id', 'raw_data'];
